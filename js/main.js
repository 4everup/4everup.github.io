...
$("#switchmenu").on("click", function () {
  ...
  if (switchmenu) {
    ...
    // $("#menu").html("<i class='fa-solid fa-xmark'></i>");//找到啦
    $("#menu").html('<img id="fa-solid fa-xmark" src="https://foreverwlwl.oss-cn-beijing.aliyuncs.com/typora/202312211318198.svg" alt="Your Image" class="custom-icon">');
  } else {
    $("#row").attr("class", "row");
    // $("#menu").html("<i class='fa-solid fa-bars'></i>");//找到啦
    $("#menu").html('<img id="fa-solid fa-bars" src="https://foreverwlwl.oss-cn-beijing.aliyuncs.com/typora/202312211318198.svg" alt="Your Image" class="custom-icon">');
  }
});
